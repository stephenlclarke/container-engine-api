...
The [v0.3.1 release evidence](docs/performance/engine-streaming-v0.3.1/timing-matrix.md) was captured on the clean signed code head `31289003ee759b4465e5b92e7c6be62d27b2fd0f` with 11 counterbalanced repetitions per lane. Candidate/Docker median ratios were 0.30x for resize, 0.38x for a 32-byte WebSocket round trip, and 0.51x for a 1 MiB WebSocket round trip; every regression gate passed and all three candidate lanes were directionally better.
