...
The [v0.3.2 release evidence](docs/performance/engine-streaming-v0.3.2/timing-matrix.md) was captured on the clean signed code head `aefa9cb13bceae5e0921faef055085d8976f3966` with 11 counterbalanced repetitions per lane. Candidate/Docker median ratios were 0.44x for resize, 0.79x for a 32-byte WebSocket round trip, and 0.45x for a 1 MiB WebSocket round trip; every regression gate passed, two candidate lanes were directionally better, and the sub-millisecond 32-byte lane was comparable.
