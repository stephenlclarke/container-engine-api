...
arguments=(
    ...
    --target ContainerEngineGateway
    --target ContainerEngineLogging
    ...
    --source-service-base-url "https://github.com/stephenlclarke/container-engine-api/blob/$source_reference"
...
<html lang="en-US">
  <head>
    <meta charset="utf-8">
    <title>container-engine-api documentation</title>
    <meta http-equiv="refresh" content="0; url=./documentation/">
  </head>
  <body>
    <p>If you are not redirected automatically, <a href="./documentation/">open the container-engine-api documentation</a>.</p>
  </body>
</html>
EOF
